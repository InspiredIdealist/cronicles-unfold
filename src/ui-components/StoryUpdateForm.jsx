...
export default function StoryUpdateForm(props) {
  const {
    id: idProp,
    story: storyModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const [storyRecord, setStoryRecord] = React.useState(storyModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(Story, idProp)
        : storyModelProp;
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(
            Story.copyOf(storyRecord, (updated) => {
      ...
      {...getOverrideProps(overrides, "StoryUpdateForm")}
      {...rest}
    >
      <TextField
        label="Created at"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || storyModelProp)}
