...
export default function StoryFragmentCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setFragment(initialValues.fragment);
    setCreatedAt(initialValues.createdAt);
    setOriginType(initialValues.originType);
    setOriginId(initialValues.originId);
    setPrevId(initialValues.prevId);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new StoryFragment(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "StoryFragmentCreateForm")}
      {...rest}
    >
      <TextField
        label="Fragment"
